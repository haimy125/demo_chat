...
io.on('connection', function(socket) { //neu co thi goi function ket noi. khi do server se tao ra bien socket de quan ly ket noi voi 1 doi tuong cu the. cu 1 nguoi truy cap se tao ra 1 bien socket cu the, quan ly ho.
